...
export const getView = async (userId, profileId, viewId) => {
    try {
        const response = await interactionApi.get(`/${userId}/profiles/${profileId}/notifications/${viewId}`);
        return response.data; // Ritorna il token o i dati dell'utente
    } catch (error) {
...
export const putView = async (userId, profileId, viewId, body) => {
    try {
        const response = await interactionApi.put(`/${userId}/profiles/${profileId}/notifications/${viewId}`, body);
        return response.data; // Ritorna il token o i dati dell'utente
    } catch (error) {
...
export const deleteView = async (userId, profileId, viewId) => {
    try {
        const response = await interactionApi.delete(`/${userId}/profiles/${profileId}/notifications/${viewId}`);
        return response.data; // Ritorna il token o i dati dell'utente
    } catch (error) {
...
export const getRecommended = async (userId, profileId, recommendedId ) => {
    try {
        const response = await interactionApi.get(`/${userId}/profiles/${profileId}/notifications/${recommendedId}`);
        return response.data; // Ritorna il token o i dati dell'utente
    } catch (error) {
...
export const putRecommended = async (userId, profileId, recommendedId, body) => {
    try {
        const response = await interactionApi.put(`/${userId}/profiles/${profileId}/notifications/${recommendedId}`, body);
        return response.data; // Ritorna il token o i dati dell'utente
    } catch (error) {
...
export const deleteRecommended = async (userId, profileId, recommendedId) => {
    try {
        const response = await interactionApi.delete(`/${userId}/profiles/${profileId}/notifications/${recommendedId}`);
        return response.data; // Ritorna il token o i dati dell'utente
    } catch (error) {
...
export const deleteReaction = async (userId, profileId, reactionsId) => {
    try {
        const response = await interactionApi.delete(`/${userId}/profiles/${profileId}/notifications/${reactionsId}`);
        return response.data; // Ritorna il token o i dati dell'utente
    } catch (error) {
